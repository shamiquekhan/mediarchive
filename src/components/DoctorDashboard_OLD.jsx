  ...
  const stats = [
    {
      ...
      value: linkedPatients.length.toString(),
      color: '#103713'
    },
    {
      icon: 'bi-calendar-check-fill',
      label: "Today's Consultations",
      value: doctorInfo.consultationsToday.toString(),
      color: '#628B35'
    },
    {
    ...
    },
    {
      ...
      value: doctorInfo.experience.split(' ')[0],
      color: '#103713'
    }
  ];
        ...
        <div className="content-area">
          ...
          {activeTab === 'dashboard' && (
            <>
              ...
              <div className="dashboard-grid">
                ...
                <div className="dashboard-card">
                  ...
                  <div className="quick-actions">
                    ...
                    <button className="action-btn" onClick={() => alert('QR Scanner - Coming Soon')}>
              ...
              <div className="dashboard-card">
                <div className="card-header">
                  <h3><i className="bi bi-clipboard-pulse"></i> Recent Consultations</h3>
                  <button className="text-btn" onClick={() => setActiveTab('consultations')}>View All</button>
                </div>
                  ...
                  {recentConsultations.slice(0, 3).map((consultation) => (
                    <div key={consultation.id} className="record-row">
                      ...
                      <div className="record-info">
                        ...
                        <p className="record-prescription">{consultation.diagnosis}</p>
                      </div>
                      <button className="record-action-btn" onClick={() => alert(`Consultation Details:\n\nPatient: ${consultation.patientName}\nDate: ${consultation.date}\nTime: ${consultation.time}\nType: ${consultation.type}\nDiagnosis: ${consultation.diagnosis}\nPrescription: ${consultation.prescription}`)}>
